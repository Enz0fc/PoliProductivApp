...
def cargar_datos(ruta):
    ...
    for hoja in hojas:
        asignatura, created = Carrera.objects.get_or_create(nombre=hoja) #importante porque me da el nombre del objeto en caso de que exista para darle este mismo valor en el campo de otra
